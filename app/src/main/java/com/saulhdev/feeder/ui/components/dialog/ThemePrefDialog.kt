...
import com.saulhdev.feeder.ui.components.ColorCircle
import com.saulhdev.feeder.ui.components.SwitchRow
...
fun ThemePrefDialogUI(
    pref: AppThemePref,
    transparencyPref: FloatPref,
    openDialogCustom: MutableState<Boolean>,
) {
    var currentTheme: NeoTheme by remember { mutableStateOf(pref.getValue()) }
    ...
    var transparency by remember { mutableFloatStateOf(transparencyPref.getValue()) }
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.pref_transparency),
                style = MaterialTheme.typography.labelLarge,
                modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp),
            )
            Slider(
                ...
                valueRange = transparencyPref.minValue..transparencyPref.maxValue,
                modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp),
            )
            ...
            Row(
                ...
                DialogPositiveButton(
                    ...
                    onClick = {
                        pref.setValue(
                            NeoTheme.CustomTheme(
                                resId =
                                    if (dynamicColor) -1
                                    else if (blackOnDark) R.style.AppTheme else R.style.AppTheme,
                                nightMode = nightMode,
                        ...
                        transparencyPref.setValue(transparency)
