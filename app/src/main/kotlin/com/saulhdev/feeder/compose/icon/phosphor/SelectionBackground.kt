...
val Phosphor.SelectionBackground: ImageVector
    get() {
        if (_selection_background != null) {
            return _selection_background!!
        }
        _selection_background = Builder(
...
private var _selection_background: ImageVector? = null
